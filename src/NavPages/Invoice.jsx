...
function Invoice(props) {
    ...
    try {
      ...
      setOption(
        response.data.map((item_invoice) => ({
          ...
          totalAmount:
            parseInt(item_invoice.item_price) +
            parseInt(item_invoice.tax_amount),
        }))
      );
    } catch (err) {
      console.log(err);
  ...
  const ViewPdf = (invoice_data_of_row) => {
    ...
    setInvoice({ ...invoice_data_of_row, amountowords: words });
              ...
              >
                ...
                <div className="invoice-header" style={styles.invoiceHeader}>
                  ...
                  >
                    ...
                    <div style={{ width: "40%" }}>
                      ...
                      <div>
                        Buyer Order No. & Date: {invoice.client_pincode}
                      </div>
                ...
                <div className="amount-summary" style={styles.amountSummary}>
                  <table className="invoice-table-amount">
                    <tbody>
                      <tr>
                        <td>Total Amount Before Tax: {invoice.total_amount}</td>
                      </tr>
                      <tr>
