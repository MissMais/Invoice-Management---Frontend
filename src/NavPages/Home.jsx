      ...
      <Box sx={{
        ...
        <Box component="main" sx={{ flexGrow: 1, width: '100%' }}>
          {dashboard.map((e, index) => (
            ...
            <Grid key={index} container spacing={2}  sx={{ mt: 3 , mb:3 }} >
              <Grid sx={{ display: 'flex', flexDirection: 'column', justifyContent: 'center', alignContent: 'center', flexWrap: 'wrap' }} item xs={12} sm={6} md={4}>
                <Box sx={{
                  ...
                  <Box sx={{textAlign:'right', padding:'0', }}>
                    ...
                    <Typography sx={{ fontSize: "25px" , fontWeight: "600" }}>{e.activity}</Typography>
                  </Box>
                </Box>
              </Grid>
              <Grid sx={{ display: 'flex', flexDirection: 'column', justifyContent: 'center', alignContent: 'center', flexWrap: 'wrap'}}  item xs={12} sm={6} md={4}>
                <Box sx={{
                  ...
                  <Box sx={{textAlign:'right', padding:'0', }}>
                    ...
                    <Typography sx={{ fontSize: "25px",fontWeight: "600"  }}>{e.sales}</Typography>
                  </Box>
                </Box>
              </Grid>
              <Grid sx={{ display: 'flex', flexDirection: 'column', justifyContent: 'center', alignContent: 'center', flexWrap: 'wrap' }}item xs={12} sm={6} md={4}>
                <Box sx={{
                  ...
                  <Box sx={{textAlign:'right', padding:'0', }}>
                    ...
                    <Typography sx={{ fontSize: "25px",fontWeight: "600"  }}>{e.income}</Typography>
                  </Box>
                </Box>
              </Grid>
              <Grid sx={{ display: 'flex', flexDirection: 'column', justifyContent: 'center', alignContent: 'center', flexWrap: 'wrap'}} item xs={12} sm={6} md={4}>
                <Box sx={{
                  ...
                  <Box sx={{textAlign:'right', padding:'0', }}>
                    ...
                    <Typography sx={{ fontSize: "25px",fontWeight: "600" , }}>{e.projects}</Typography>
                  </Box>
                </Box>
              </Grid>
              <Grid sx={{ display: 'flex', flexDirection: 'column', justifyContent: 'center', alignContent: 'center', flexWrap: 'wrap'}}  item xs={12} sm={6} md={4} >
                <Box sx={{
                  ...
                  <Box sx={{textAlign:'right' }}>
                    ...
                    <Typography sx={{ fontSize: "25px",fontWeight: "600"  }}>{e.clients}</Typography>
                  </Box>
                </Box>
              </Grid>
            </Grid>
